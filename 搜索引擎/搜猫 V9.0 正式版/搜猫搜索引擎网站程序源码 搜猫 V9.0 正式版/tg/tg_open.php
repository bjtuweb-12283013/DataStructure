...
;echo '
  <tr>
    ...
    <td align="center"><a target="_blank" href="../s?wd=';echo urlencode($link['keywords']);;echo '">搜索</a></td>
    <td align="center"><a href="?action=del&link_id=';echo $link['link_id'];echo '" onclick="if(!confirm(\'确认删除码?\')) return false;">删除</a></td>
  </tr>
