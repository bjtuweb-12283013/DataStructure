...
switch ($action)
{
	...
	case "del":
	$db->query("delete from ve123_tg_links where link_id='".intval($_GET["link_id"])."'");
	break;
}	
?>
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tablebg">
  ...
  <?php
  $result=$db->query("select * from ve123_tg_links");
...
global $db,$p_cid;
  if ($do_action=="modify")
  {
	  ...
	  $sql="select * from ve123_tg_links where link_id='$link_id'";
	  $rs=$db->get_one($sql);
