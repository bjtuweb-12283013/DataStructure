            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="750"><br> <TABLE cellSpacing=0 cellPadding=0 width="99%" border=0>
                        ...
                        src="<?php echo $config["url"];?>/images/logo-80px.gif" alt=config border=0
                        align=bottom></A>
...
&lt;a href="<?php echo $config["url"];?>/"&gt;&lt;img src="<?php echo $config["url"];?>/images/logo-80px.gif" alt="config" align="bottom" border="0"&gt;&lt;/a&gt;
