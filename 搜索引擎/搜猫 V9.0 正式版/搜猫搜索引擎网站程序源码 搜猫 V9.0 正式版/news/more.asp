...
clk=request.QueryString("clk")
bs=request.QueryString("bs")
sr=request.QueryString("sr")
'判断
If word<>"" Then
    If pn=0 Then
url="http://news.baidu.com/ns?cl="&cl&"&rn="&rn&"&tn="&tn&"&word="&word&"&clk="&clk&""
    Else
url="http://news.baidu.com/ns?bt="&bt&"&et="&et&"&si="&si&"&rn="&rn&"&tn="&th&"&ie="&ie&"&ct="&ct&"&word="&word&"&pn="&pn&"&cl="&cl&"&clk="&clk&"&bs="&bs&"&sr="&sr&""
    End If
Else
...
html=replace(html,"href=""../tieba/"">贴吧","href=""../tieba/"">贴吧")
html=replace(html,"href=""../zhidao/"">知道","href=""../zhidao/"">知道")
...
html=replace(html,"文明办网举报电话：010-82621188-6322 &nbsp;举报邮箱：www@1230530.com"," ")
