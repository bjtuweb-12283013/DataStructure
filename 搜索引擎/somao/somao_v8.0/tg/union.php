...
<div class="wrapper">
  ...
  <tr>
    ...
    <td>
	<textarea id="code_1" name="textfield" cols="60" rows="6">&lt;a href="<?php echo $zeigou["url"]."?u=".$user["user_id"];?>" target="_blank"&gt;<?php echo $zeigou["name"];?>&lt;/a&gt;</textarea>
  ...
  <tr>
    <td>搜索方式</td>
    <td>
<TEXTAREA id="code_2" name=textarea rows=6 cols=60>&lt;form action="<?php echo $zeigou['url'];?>" target="_blank"&gt;
&lt;table bgcolor="#FFFFFF"&gt;&lt;tr&gt;&lt;td&gt;
&lt;a href="<?php echo $zeigou["url"];?>/"&gt;&lt;img src="<?php echo $zeigou["url"];?>/images/logo-80px.gif" alt="ZeiGou" align="bottom" border="0"&gt;&lt;/a&gt;
