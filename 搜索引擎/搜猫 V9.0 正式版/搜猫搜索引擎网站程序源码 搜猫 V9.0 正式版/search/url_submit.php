  ...
  <tr>
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        　· <?php echo $config["name"];?>不保证一定能收录您提交的网站,提交网站默认收录于网页，属于其他类需要大范围收录请联系站长 <br>
...
<table width="95%" border=0 align="center">
  <tr> 
    <td align=center class=p1> <font color="#666666">&copy; 2009 </font> 
      <a href=<?php echo $config["url"];?>/><font color="#666666"><?php echo $config["name"];?>搜索引擎</font></a></td>
  </tr>
</table>
</body></html>